    ...
    handler: () => {
      window.location.href = "/";
          ...
          handler: () => {
            ...
            },{id: "post-taller-quot-cinco-pasos-para-hacer-un-análisis-estadístico-quot",
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/danielvertex.bsky.social", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/daniel-herrera-aguirre", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
